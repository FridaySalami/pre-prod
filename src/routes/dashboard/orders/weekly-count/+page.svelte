        ...
        {#each dailyOrders as day}
          <div class="flex flex-col items-center flex-1">
            <div class="w-full flex items-end justify-center">
              <div 
                class="bg-blue-500 hover:bg-blue-600 transition-all rounded-t-md w-full max-w-[40px]" 
        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Orders Processed</th>
            </tr>
          </thead>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div class="bg-white rounded-lg shadow-md p-4">
        ...
        {#if dailyOrders.length}
          {@const busiestDay = dailyOrders.reduce((max, day) => day.count > max.count ? day : max, dailyOrders[0])}
          <p class="text-2xl font-bold">{busiestDay.formattedDate.split(',')[0]} ({busiestDay.count})</p>
        {:else}
