...
>
  ...
  >
    <header class="panel-header">
      {#if !editMode}
        ...
        <div class="header-actions">
          <button class="icon-button edit-button" on:click={enterEditMode} aria-label="Edit project">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M16.474 5.408L18.592 7.526L7.526 18.592L5.408 16.474L16.474 5.408ZM3 17.25L7 18L6.25 14.5L3 17.25ZM20.71 4.04C21.1 3.65 21.1 3 20.71 2.61L18.39 0.29C18 -0.1 17.35 -0.1 16.96 0.29L15 2.25L18.75 6L20.71 4.04Z" fill="currentColor"/>
            </svg>
          </button>
        </div>
      {:else}
      ...
      <button class="icon-button close-button" on:click={handleClose} aria-label="Close panel">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M3.5 3.5L12.5 12.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
        </svg>
      </button>
    </header>
      ...
      <div class="project-info">
        ...
        <div class="field-group">
          {#if !editMode}
            ...
            <p class="field-value description">{project.detailed_description || "No detailed description provided."}</p>
          {:else}
            <label for="detailed-textarea">Detailed Description</label>
            <textarea id="detailed-textarea" bind:value={editedDetailed} placeholder="Add detailed description here..."></textarea>
          {/if}
        </div>
        ...
        <div class="field-group-row">
          ...
          <div class="field-group">
            ...
            {:else}
              ...
              <input id="owner-input" type="text" bind:value={editedOwner} placeholder="Assign an owner" />
            {/if}
          </div>
        </div>
      </div>
      ...
      <div class="reactions-section">
        ...
        >
          <svg class="like-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M2 20H4V10H2V20ZM22 10C22 9.45 21.55 9 21 9H14.69L15.64 3.43L15.67 3.11C15.67 2.7 15.5 2.32 15.23 2.05L14.17 1L7.59 7.59C7.22 7.95 7 8.45 7 9V18C7 19.1 7.9 20 9 20H18C18.83 20 19.54 19.5 19.84 18.78L21.86 12.73C21.95 12.5 22 12.26 22 12V10.08L22 10Z" fill="currentColor"/>
          </svg>
    ...
    <footer class="panel-footer">
      <button class="text-button delete-button" on:click={handleDelete} type="button">Delete Submission</button>
    </footer>
  </div>
</div>
