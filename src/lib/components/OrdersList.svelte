<script lang="ts">
	import ExportOrdersCsv from '$lib/components/ExportOrdersCsv.svelte';
	import ItemSku from '$lib/components/ItemSku.svelte'; // Import the new component
	import type { ProcessedOrder } from '$lib/types/types';
