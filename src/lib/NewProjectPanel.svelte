		...
		<form on:submit|preventDefault={handleSubmit}>
			...
			<div class="form-group">
				...
				<div class="readonly-field">
					...
					>
						<path
							d="M19 10H17V7C17 4.24 14.76 2 12 2C9.24 2 7 4.24 7 7V10H5C3.9 10 3 10.9 3 12V20C3 21.1 3.9 22 5 22H19C20.1 22 21 21.1 21 20V12C21 10.9 20.1 10 19 10ZM12 17C10.9 17 10 16.1 10 15C10 13.9 10.9 13 12 13C13.1 13 14 13.9 14 15C14 16.1 13.1 17 12 17ZM15 10H9V7C9 5.34 10.34 4 12 4C13.66 4 15 5.34 15 7V10Z"
							fill="currentColor"
						/>
					</svg>
					<!-- Hidden input for form submission -->
					<input id="submitted-by-input" type="hidden" bind:value={submitted_by} required />
				</div>
			</div>
